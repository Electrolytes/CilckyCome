...
<table> 
       <tr class="AltaRestaurantes">
            <td colspan="10" style="text-align:center">
             <asp:Label ID="LblClaveRestaurante" runat="server" Text="Clave Restaurante"></asp:Label>
            </td>
            <td>
        ...
        <tr class="AltaRestaurantes">                        
             <td colspan="10" style="text-align:center">  
            <asp:Button ID="BtnAgregarPlatillo" runat="server" Text="Ingresar Platillo "  OnClick="BtnResgistro_Click" Width="112px"  />
            </td>
             <td colspan="10" style="text-align:center">
